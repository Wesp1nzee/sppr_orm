...
SECTION_TITLES: dict[str, str] = {
    ...
    "этапы": "Этапы",
    "проверка": "Проверка",
    "результаты_по_критериям": "Результаты по критериям",
    "сгенерированные_документы": "Сгенерированные документы",
    "журнал_действий": "Журнал действий",
    "название_дела": "Название дела",
